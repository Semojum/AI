...
#
# ★ **쪽을 통째로 다시 읽지 않는다.** 재추출은 실측 107~119초(Opus)·49~135초(Sonnet)라
...
#   · 신호가 뜬 쪽읽기 6건에 담긴 동그라미 기호 33개가 **전수 이름표 오독**(정밀도 33/33)
#   · 신호가 안 뜬 54건에서 이 오독이 난 적 **0건**(재현율 6/6)
#   · 되묻기 16벌 전수 정답 — 한 쪽에 ㉠ 셋·㉡ 하나가 섞인 자리도 갈라 냈다.
